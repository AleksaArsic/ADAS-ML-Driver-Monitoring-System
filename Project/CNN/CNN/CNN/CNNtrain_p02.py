...
imgsDir = "C:\\Users\\arsic\\Desktop\\Diplomski\\DriverMonitoringSystem\\Dataset\\trainingSet_phase02\\"
normalizedDataPath = "C:\\Users\\arsic\\Desktop\\Diplomski\\DriverMonitoringSystem\\Dataset\\trainingSet_phase02_csv\\trainingSet_phase02_normalized.csv"
...
def plotTrainingResults(val_acc, val_loss, train_acc, train_loss):
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig('model_phase02_loss.png')

if __name__ == "__main__":
    script_start = datetime.datetime.now()

    #minMaxValues = Utilities.readMinMaxFromCSV(minMaxCSVpath)
    [images, categories, filenames] = Utilities.loadImagesAndCategories(images, imgsDir, categories, normalizedDataPath, 2, inputWidth, inputHeight)
